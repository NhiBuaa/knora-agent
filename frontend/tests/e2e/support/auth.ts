...
const credentialsEnvironmentNames: Record<
  M5E2EIdentity,
...
> = {
  ...
  "other-workspace": [
    "M5_E2E_OTHER_WORKSPACE_USERNAME",
    "M5_E2E_OTHER_WORKSPACE_PASSWORD",
  ],
...
const expectedSessionShapes: Record<M5E2EIdentity, SessionShape> = {
  user: {
    workspaceId: "m5-workspace",
    capabilities: ["documents:read", "documents:write", "questions:ask"],
  },
  "delete-user": {
    workspaceId: "m5-workspace",
    capabilities: [
  ...
  "other-workspace": {
    workspaceId: "m5-other-workspace",
    capabilities: [
      "documents:read",
      "documents:write",
      "questions:ask",
...
export async function loginAs(
  ...
  const updateProfile = page.getByRole("heading", {
