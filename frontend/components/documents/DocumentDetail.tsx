...
export function DocumentDetail({ workspaceId, documentId, canRequestDeletion = false }: { workspaceId: string; documentId: string; canRequestDeletion?: boolean }) {
