...
Locked guide: `.agents/manual-tests/milestone-3/63-remediation-issue-63-v9.md`.

## Acceptance

- #68 and #69 are closed with accepted evidence before this ticket starts.
- Guide v9 is independently reviewed/approved without rewriting v6/v7/v8 histories.
...
- Canonical executor identity and response-completion clock fault probes are required in the final
  acceptance evidence.
