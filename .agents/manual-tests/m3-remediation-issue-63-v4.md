...
- Supersedes: unapproved `m3-remediation-issue-63-v3`; v3, v2 and v1 remain unchanged and must not be executed
- Guide revision: `m3-remediation-issue-63-v4`
...
- Approval payload:
  ...
  - Attestation commit: `b8d4b3bf417fd07d48e8b9019c0275b6b4dbe9da`
  - Attestation blob: `6da93ab848b520232a60e92dc1d2017251801d49`
  - Attestation SHA-256: `ac997ebe727381c3f67e0a3e5022a839376172a3d6552b26312d70e281ef92ac`
- Sealed archive:
  `.agents/review/m3-improvement-claim-v1-approval-sealed-v1.tar`
  - SHA-256: `2918c865752318b18fca5e483331ffb26a0e62e4d771471b2a55123778dd18ef`
- Sealed manifest SHA-256:
  `c92a8f438ad625d0314beda056d02b0fb51021fb7162bacc708ab27468ebaa06`
- Closure result:
  `.agents/review/m3-improvement-claim-v1-approval-closure-v1.json`
  - SHA-256: `2cc10886812dcb655cf258231a5ba775b5f30a8a2f9c11144d1be3baaf14e341`
...
- Execution gate: the claim-rule authority is approved/effective, but this v4 guide is pending external review and explicit human approval/lock. Do not implement or execute any case, and do not create an Evaluation record, before this guide is locked.
...
- Steps:
  ...
  4. Create disposable negative fixtures that mutate each authority identity, projection policy
     ...
     override. Submit each to canonical production selection.
...
This v4 guide is not locked. The pinned claim-rule authority is already `APPROVED_EFFECTIVE`, but this guide becomes immutable only after external review, explicit human approval and lock. Any later semantic change requires `m3-remediation-issue-63-v5`; v3, v2 and v1 remain unchanged and must not be executed. Store future run observations separately as JSONL Evaluation records.
