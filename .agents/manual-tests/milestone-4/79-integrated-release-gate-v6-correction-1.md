# Manual Test Guide: M4.5 final-review remediation v6 correction-1
...
- Guide revision: `m4-79-integrated-release-gate-v6-correction-1`
- Supersedes: `m4-79-integrated-release-gate-v6` for a binding-only Spec-axis digest correction; all 17 Test Cases and remediation scope are unchanged.
