# Manual Test Guide: M4.5 final-review remediation v6 correction-2
...
- Structured Test Cases: `.agents/review/m4-issue-79-test-cases-v6-correction-1.json`
- Guide revision: `m4-79-integrated-release-gate-v6-correction-2`
- Supersedes: `m4-79-integrated-release-gate-v6-correction-1` for the TC-14 public-mapping correction identified by external review; all 17 Test Cases and remediation scope remain unchanged.
- Approval status: pending independent external guide review and explicit repository-owner approval
- Evaluation history: `.agents/manual-tests/milestone-4/79-integrated-release-gate-v6-correction-1.evaluations.jsonl`
...
- `reconciled_request_rejected` persists as a durable provider request rejection and maps to `502 TOOL_PROVIDER_REQUEST_FAILED`, never indeterminate `202` or untyped `500`.
