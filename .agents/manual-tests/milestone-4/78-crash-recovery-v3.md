# Manual Test Guide: M4.4 crash recovery and provider reconciliation v3
...
- Guide revision: `m4-78-crash-recovery-v3`
- Test-case source: `.agents/review/m4-issue-78-test-cases-v3.json`
- Prior guide review: `.agents/review/m4-issue-78-guide-external-review-v2.json`,
  `REQUEST_CHANGES` with two Major oracle findings
- External guide review evidence: pending `.agents/review/m4-issue-78-guide-external-review-v3.json`
- Human approval evidence: pending `.agents/review/m4-issue-78-guide-approval-v3.json`
- Revision scope: v3 changes only TC-04/GEV-02 observation-read versus write/effect counters and the
  TC-06/GEV-03 closed non-terminal outcome matrix requested by guide review v2. All other v2 cases,
  lifecycle/concurrency oracles and release boundaries remain unchanged.
