...
- Identity record `.agents/review/identities/codex-agent-m3-final-package-review-v4.json`
...
- Steps: load the approved closure `.agents/review/m3-remediation-v4-review-closure-final.json`,
