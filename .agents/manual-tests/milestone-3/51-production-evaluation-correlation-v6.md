...
- Guide revision: issue-51-v6
- Supersedes: locked `issue-51-v5`, which remains unchanged
...
- Purpose: Prove the public answer, public citations, and Evidence Alias mapping are the source of
  truth without weakening the binding/correlation gate.
- Steps:
  1. Run an answerable case whose binding and trace pass TC-01.
  2. Verify public marker and citation order plus public aliases.
  3. Exercise missing, duplicate, out-of-order, or unknown public aliases, and missing/conflicting
     trace/binding provenance alongside plausible public citations.
- Expected results:
  - TC-01 failure prevents a successful citation evaluation.
  - After TC-01 succeeds, trace provenance may verify correlation only; it cannot repair, infer,
    or substitute public citation data.
- Evidence to capture:
  - Public response projection, correlation-precedence test output, and structural findings.
